...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return FormError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Form; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return Note; });
...
var Form = function () {
    ...
    _createClass(Form, [{
        ...
        value: function submit(requestType, url) {
            ...
            axios[requestType](url, this.data()).then(this.onSuccess.bind(this)).catch(this.onFail.bind(this)).then(this.form_loading = false);
        }
    }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_sweetalert2__ = __webpack_require__(55);
window.Vue = __webpack_require__(7);


Vue.use(__WEBPACK_IMPORTED_MODULE_0_vue_sweetalert2__["a" /* default */]);

Vue.component('notes-application', __webpack_require__(59));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert2_dist_sweetalert2_min_js__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sweetalert2_dist_sweetalert2_min_css__ = __webpack_require__(57);
...
Component.options.__file = "resources/js/components/NotesSPA.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f5fe89e4", Component.options)
  } else {
    hotAPI.reload("data-v-f5fe89e4", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classes_js__ = __webpack_require__(11);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      colors: [{ color: "White", class: "text-dark bg-light" }, { color: "Blue", class: "text-dark bg-primary" }, { color: "Yellow", class: "text-dark bg-warning" }, { color: "Green", class: "text-dark bg-success" }],
      note_list: [],
      new_errors: new __WEBPACK_IMPORTED_MODULE_0__classes_js__["b" /* FormError */]()
    };
  },

  methods: {
    notecount: function notecount() {
      if (this.note_list.length == 0) {
        return 1;
      }
      return this.note_list[this.note_list.length - 1].id + 1;
    },
    getNote: function getNote(note_id) {
      return this.note_list[this.note_list.map(function (note) {
        return note.id;
      }).indexOf(note_id)];
    },
    addNote: function addNote() {
      ...
      var errors = {};
      ["title", "body", "color"].forEach(function (reqVal) {
        if (!_this.new_note[reqVal]) {
      ...
      this.note_list.push(new __WEBPACK_IMPORTED_MODULE_0__classes_js__["c" /* Note */](this.new_note));
      this.new_note = [];
    },
    confirmNoteRemoval: function confirmNoteRemoval(note_id) {
      var _this2 = this;

      this.$swal({
        title: "Confirm Note Removal",
        text: "Are you sure you want to remove note #" + note_id + "? This cannot be un-done!",
        type: "warning",
        ...
        if (result.value) {
          _this2.deleteNote(note_id);
          _this2.$swal("Deleted!", "Your note has been deleted.", "success");
        }
      });
    },
    deleteNote: function deleteNote(note_id) {
      var i = this.note_list.map(function (note) {
        return note.id;
      }).indexOf(note_id); // find index of your object
      this.note_list.splice(i, 1); // remove it from array
    },
    editNote: function editNote(note_id) {
      var note = this.getNote(note_id);
      note.edit_active = true;
    },
    saveNoteChanges: function saveNoteChanges(note_id) {
      var note = this.getNote(note_id);
      note.edit_errors.clear();

      var errors = {};
      ["title", "body"].forEach(function (reqVal) {
    ...
    discardNoteChanges: function discardNoteChanges(note_id) {
      var note = this.getNote(note_id);
...
var render = function() {
  ...
  return _c("div", { staticClass: "row justify-content-md-center" }, [
    _c("div", { staticClass: "col-sm-12 col-md-12 col-lg py-2" }, [
      _c("div", { staticClass: "card  text-white bg-dark " }, [
        _c("div", { staticClass: "card-header" }, [_vm._v("Create New Note")]),
        _vm._v(" "),
        _c("div", { staticClass: "card-body" }, [
          _c("div", { staticClass: "form-group row px-3" }, [
            _c("label", { attrs: { for: "note_title" } }, [
              _vm._v(
                "\n                        Note Title\n                    "
              )
            ]),
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.new_note.title,
                  expression: "new_note.title"
                }
              ],
              staticClass: "form-control",
              class: { "is-invalid": _vm.new_errors.has("title") },
              attrs: { type: "text", required: "", maxlength: "30" },
              domProps: { value: _vm.new_note.title },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.new_note, "title", $event.target.value)
                }
              }
            })
          ]),
          _vm._v(" "),
          _vm.new_errors.has("title")
            ? _c(
                "div",
                ...
                [
                  _c(
                    "div",
                    { staticClass: "alert bg-danger text-white p-2 m-2" },
                    [
                      _vm._v(
                        "\n                        " +
                          _vm._s(_vm.new_errors.get("title")) +
                          "\n                    "
                      )
                    ]
                  )
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.new_note.body,
                  expression: "new_note.body"
                }
              ],
              staticClass: "form-control",
              class: { "is-invalid": _vm.new_errors.has("body") },
              attrs: { required: "", type: "text", resize: "false" },
              domProps: { value: _vm.new_note.body },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.new_note, "body", $event.target.value)
                }
              }
            })
          ]),
          _vm._v(" "),
          _vm.new_errors.has("body")
            ? _c(
                "div",
                { staticClass: "form-group row justify-content-center" },
                [
                  _c(
                    ...
                    [
                      _vm._v(
                        "\n                        " +
                          _vm._s(_vm.new_errors.get("body")) +
                          "\n                    "
                      )
                    ]
                  )
          ...
          _c("div", { staticClass: "form-group row align-items-center" }, [
            _vm._m(0),
            _vm._v(" "),
            _c("div", { staticClass: "w-100 d-lg-none" }),
            _vm._v(" "),
            _c("div", { staticClass: "col-lg col-md-12 py-2" }, [
              _c(
                "select",
                {
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.new_note.color,
                      expression: "new_note.color"
                    }
                  ],
                  staticClass: "form-control",
                  class: { "is-invalid": _vm.new_errors.has("color") },
                  on: {
                ...
                _vm._l(_vm.colors, function(item) {
                  return _c(
                    "option",
                    { key: item.color, domProps: { value: item.class } },
                    [
                      _vm._v(
                        "\n                                " +
                          _vm._s(item.color) +
                ...
                [
                  _c(
                    ...
                    [
                      _vm._v(
                        "\n                        " +
                          _vm._s(_vm.new_errors.get("color")) +
                          "\n                    "
                      )
                    ]
                  )
    ...
    _vm._v(" "),
    _c("div", { staticClass: "col-sm-12 col-md-12 col-lg-8 py-2" }, [
      _c("div", { staticClass: "card  text-white bg-dark " }, [
        _c("div", { staticClass: "card-header" }, [_vm._v("My Notes")]),
        _vm._v(" "),
        _c(
          "div",
          { staticClass: "card-body" },
          [
            _vm.note_list.length == 0
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm._l(_vm.note_list, function(note) {
              return _c(
                "div",
                {
                  key: note.id,
                  staticClass: "row justify-content-center my-3 p-0"
                },
                [
                  _c(
                    "div",
                    { staticClass: "col-md-10 card p-0", class: note.color },
                    [
                      _c(
                        "div",
                        {
                          staticClass:
                            "card-header justify-content-center row m-0 p-0"
                        },
                        [
                          _c("div", { staticClass: "text-left col-auto" }, [
                            _c("h4", { staticClass: "px-1" }, [
                              _c(
                                "span",
                                { staticClass: "badge badge-secondary" },
                                [_vm._v("#" + _vm._s(note.id))]
                              )
                            ])
                          ]),
                          _vm._v(" "),
                          _c("div", { staticClass: "col-8" }, [
                            note.edit_active
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: note.edit_props.title,
                                      expression: "note.edit_props.title"
                                    }
                                  ],
                                  staticClass:
                                    "form-control text-center mt-2 pb-0 my-0",
                                  staticStyle: { "font-size": "1.35rem" },
                                  attrs: { type: "text" },
                                  domProps: { value: note.edit_props.title },
                                  on: {
                                    input: function($event) {
                                      if ($event.target.composing) {
                                        return
                              ...
                              : _c(
                                  "p",
                                  {
                                    staticClass: "h4 text-center pt-2 pb-0 my-0"
                                  },
                                  [
                                    _vm._v(
                                      "\n                                    " +
                            ...
                            _c(
                              ...
                              {
                                staticClass:
                                  "h6 text-center text-dark pt-0 mt-0"
                              },
                              [
                                _c("small", [
                                  _vm._v("Created " + _vm._s(note.created_at))
                                ])
                              ]
                            ),
                            _vm._v(" "),
                            note.edit_active
                              ? _c(
                                  "p",
                                  { staticClass: "h6 text-center pt-0 mt-0" },
                                  [
                                    _c(
                                      "span",
                                      { staticClass: "badge badge-danger" },
                                      [_vm._v("Currently Editing")]
                                    )
                                  ]
                                )
                              : _vm._e()
                          ...
                          _vm._v(" "),
                          _c("div", { staticClass: "text-right col-auto" }, [
                            _c(
                              "a",
                              {
                                staticClass: "badge badge-secondary px-1",
                                attrs: { href: "#" },
                                on: {
                                  click: function($event) {
                                    $event.preventDefault()
                                    _vm.confirmNoteRemoval(note.id)
                                  }
                                }
                              },
                              [
                                _c("i", {
                                  staticClass: "fa text-danger fa-times fa-2x"
                                })
                              ]
                            ),
                            _vm._v(" "),
                            _c(
                              ...
                              [
                                _c("i", {
                                  staticClass:
                                    "fa text-info fa-pencil-alt fa-2x"
                                })
                              ]
                            )
                          ])
                      ...
                      _c("div", { staticClass: "card-body" }, [
                        note.edit_active
                          ? _c(
                              "textarea",
                              {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: note.edit_props.body,
                                    expression: "note.edit_props.body"
                                  }
                                ],
                                staticClass: "form-control",
                                class: {
                                  "is-invalid": note.edit_errors.has("body")
                                },
                                attrs: {
                                  required: "",
                                  type: "text",
                                ...
                                domProps: { value: note.edit_props.body },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
                        ...
                        note.edit_active
                          ? _c(
                              "button",
                              {
                                staticClass: "m-2 btn btn-submit",
                                on: {
                                  click: function($event) {
                                    _vm.saveNoteChanges(note.id)
                                  }
                                }
                              },
                              [_vm._v("Save Changes")]
                        ...
                        note.edit_active
                          ? _c(
                              "button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    _vm.discardNoteChanges(note.id)
                                  }
                                }
                              },
                              [_vm._v("Cancel")]
                        ...
                        note.edit_errors.any()
                          ? _c(
                              ...
                              [
                                note.edit_errors.has("title")
                                  ? _c(
                                      "div",
                                      {
                                        staticClass:
                                          "alert bg-danger text-white p-2 m-2"
                                      },
                                      [
                                        _vm._v(
                                          "\n                                    " +
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f5fe89e4", module.exports)
  }
}
